...
interface AngleUnit {
  ...
  label: string;
  short: string;
  toDeg: number; // conversion factor to degrees
}
...
export default function AngleConverter() {
  ...
  const [inputValue, setInputValue] = useState<string>('180');
  const [fromUnit, setFromUnit] = useState<string>('deg');
