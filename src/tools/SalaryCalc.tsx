            ...
            <Grid container spacing={1.5}>
              <Grid size={{ xs: 12, sm: 4 }}>
                <Paper elevation={0} sx={{ p: 2, borderRadius: 2, bgcolor: alpha(theme.palette.error.main, 0.06), textAlign: 'center' }}>
                  ...
                  <Typography variant="h6" fontWeight={700} color="error">{ndfl13.toLocaleString('ru-RU', { maximumFractionDigits: 0 })} ₽</Typography>
                </Paper>
              </Grid>
              <Grid size={{ xs: 12, sm: 4 }}>
                <Paper elevation={0} sx={{ p: 2, borderRadius: 2, bgcolor: alpha(theme.palette.success.main, 0.08), textAlign: 'center' }}>
                  ...
                  <Typography variant="h6" fontWeight={700} sx={{ color: theme.palette.success.main }}>{netMonthly.toLocaleString('ru-RU', { maximumFractionDigits: 0 })} ₽</Typography>
                </Paper>
              </Grid>
              <Grid size={{ xs: 12, sm: 4 }}>
                <Paper elevation={0} sx={{ p: 2, borderRadius: 2, bgcolor: alpha(theme.palette.success.main, 0.08), textAlign: 'center' }}>
                  <Typography variant="caption" color="text.secondary">На руки (год)</Typography>
                  <Typography variant="h6" fontWeight={700} sx={{ color: theme.palette.success.main }}>{netAnnual.toLocaleString('ru-RU', { maximumFractionDigits: 0 })} ₽</Typography>
                </Paper>
              </Grid>
            </Grid>
          </>
