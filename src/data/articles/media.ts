...
|---|---|---|
| 16:9 | 1920×1080, 3840×2160 | YouTube, телевидение, стриминг |
| 9:16 | 1080×1920 | TikTok, Instagram Reels, YouTube Shorts |
| 4:3 | 1024×768 | Классическое ТВ, презентации |
| 1:1 | 1080×1080 | Instagram посты, аватары |
| 21:9 | 2560×1080 | Кинематограф, ультраширокие мониторы |

## Как рассчитать размеры

Если вы знаете одну сторону и соотношение, вторая вычисляется автоматически:
- При 16:9 и ширине 1920: высота = 1920 / 16 × 9 = 1080
- При 9:16 и высоте 1920: ширина = 1920 / 16 × 9 = 1080
...
|---|---|---|
| 1920×1080 | 9:16 (TikTok) | Кадрирование по центру |
| 1920×1080 | 1:1 (Instagram) | Обрезка по квадрату |
| 1920×1080 | 4:5 (Instagram пост) | Лёгкая обрезка сверху/снизу |
