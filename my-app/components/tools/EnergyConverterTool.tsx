...
const UNIT_DATA: Record<string, { factor: number; label: string }> = {
  "J": { factor: UNITS["J"], label: "Джоуль (J)" },
  "kJ": { factor: UNITS["kJ"], label: "Килоджоуль (kJ)" },
  "kcal": { factor: UNITS["kcal"], label: "Килокалория (kcal)" },
  "kWh": { factor: UNITS["kWh"], label: "Киловатт·час (kWh)" },
  "Wh": { factor: UNITS["Wh"], label: "Ватт·час (Wh)" },
};

interface EnergyConverterToolProps { t: (key: string) => string; }
